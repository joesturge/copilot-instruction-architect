...
Knowledge comes from both repository evidence and conversation observations. Conversation observations flow through the same knowledge → semantic evaluation → representation pipeline as repository knowledge.

Session-end behavior depends on configured autonomy:
- `suggest` / `review`: print proposals
- `automatic`: apply proposed conversation learning to Copilot files
